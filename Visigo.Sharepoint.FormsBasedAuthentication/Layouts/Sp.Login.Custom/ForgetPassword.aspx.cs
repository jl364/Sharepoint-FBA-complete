...
namespace Sp.Login.Custom.Layouts.Sp.Login.Custom
{
    public partial class ForgetPassword : UnsecuredLayoutsPageBase
    {
        ...
        //it allows access this page to anonymous users by overriding AllowNullWeb method
        ...
        private void AddPasswordRecoveryControl()
        {
            ...
            _ctlPasswordRecovery.UserNameTemplate = new TemplateLoader(_userNameTemplate, Page);
            _ctlPasswordRecovery.QuestionTemplate = new TemplateLoader(_questionTemplate, Page);
            _ctlPasswordRecovery.SuccessTemplate = new TemplateLoader(_successTemplate, Page);
